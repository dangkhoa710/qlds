		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
						...
						<div class="col-md-6 col-sm-12">
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Thêm thu</li>
								</ol>
							</nav>
						</div>
					</div>
				...
				<div class="pd-20 card-box mb-30">
					...
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-blue h4">Thêm các khoản thu</h4>	
						</div>
					</div>
					<br>
					<form role="form" action="{{URL::to('luu-thongtin-thu')}}" method="post" enctype="multipart/form-data">
                            {{ csrf_field() }}
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">Nội dung</label>
							<div class="col-sm-12 col-md-10">
								<input class="form-control" type="text" placeholder="Nhập nội dung khoản thu" name="content">
							</div>
						</div>
